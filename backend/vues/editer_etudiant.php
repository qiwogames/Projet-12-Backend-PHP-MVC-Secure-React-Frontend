<div class="container mt-3">
    <?php
    require_once 'details_etudiant.php';
    ?>
</div>
...
<div class="box">
    <form class="mt-5" method="post">
        <h2 class="title is-2 has-text-info">Editer l' etudiant</h2>
        ...
        <div class="field">
            <button name="btn_ajouter_etudiant" class="button is-info">Mettre à jour étudiant</button>
