...
<div class="container mt-3">
    <?php
    require_once 'enseignantID.php';
    ?>
</div>

<div class="box">
    <form method="post">
        <h2 class="title is-2 has-text-info">Mettre à jour l' enseignant</h2>
        ...
        <div class="field">
            <button name="btn_ajouter_enseignant" class="button is-info">Mettre à jour enseignant</button>
